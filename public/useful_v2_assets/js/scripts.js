...
(function (global, factory) {
  ...
  var Carousel = function ($$$1) {
    ...
    var ClassName = {
      CAROUSEL: 'yourex-carousel',
      ACTIVE: 'yourex-active',
      SLIDE: 'yourex-slide',
      RIGHT: 'yourex-carousel-item-right',
      LEFT: 'yourex-carousel-item-left',
      NEXT: 'yourex-carousel-item-next',
      PREV: 'yourex-carousel-item-prev',
      ITEM: 'yourex-carousel-item'
    };
    var Selector = {
      ACTIVE: '.yourex-active',
      ACTIVE_ITEM: '.yourex-active.yourex-carousel-item',
      ITEM: '.yourex-carousel-item',
      NEXT_PREV: '.yourex-carousel-item-next, .yourex-carousel-item-prev',
      INDICATORS: '.yourex-carousel-indicators',
  ...
  var Collapse = function ($$$1) {
    ...
    var ClassName = {
      SHOW: 'yourex-show',
      COLLAPSE: 'yourex-collapse',
      COLLAPSING: 'yourex-collapsing',
      COLLAPSED: 'yourex-collapsed'
    };
    var Dimension = {
      WIDTH: 'width',
      HEIGHT: 'height'
    ...
    var Selector = {
      ACTIVES: '.yourex-show, .yourex-collapsing',
  ...
  var Dropdown = function ($$$1) {
    ...
    var ClassName = {
      DISABLED: 'yourex-disabled',
      SHOW: 'yourex-show',
      DROPUP: 'yourex-dropup',
      DROPRIGHT: 'yourex-dropright',
      DROPLEFT: 'yourex-dropleft',
      MENURIGHT: 'yourex-dropdown-menu-right',
      MENULEFT: 'yourex-dropdown-menu-left',
      POSITION_STATIC: 'yourex-position-static'
    };
    var Selector = {
      DATA_TOGGLE: '[data-toggle="dropdown"]',
      FORM_CHILD: '.yourex-dropdown form',
      MENU: '.yourex-dropdown-menu',
      NAVBAR_NAV: '.yourex-navbar-nav',
      VISIBLE_ITEMS: '.yourex-dropdown-menu .yourex-dropdown-item:not(.disabled)'
    };
    var AttachmentMap = {
      TOP: 'top-start',
      TOPEND: 'top-end',
  ...
  var Modal = function ($$$1) {
    ...
    var ClassName = {
      SCROLLBAR_MEASURER: 'yourex-modal-scrollbar-measure',
      BACKDROP: 'yourex-modal-backdrop',
      OPEN: 'yourex-modal-open',
      FADE: 'yourex-fade',
      SHOW: 'yourex-show'
    };
    var Selector = {
      DIALOG: '.yourex-modal-dialog',
      DATA_TOGGLE: '[data-toggle="modal"]',
      DATA_DISMISS: '[data-dismiss="modal"]',
      FIXED_CONTENT: '.yourex-fixed-top, .yourex-fixed-bottom, .yourex-is-fixed, .yourex-sticky-top',
      STICKY_CONTENT: '.yourex-sticky-top',
      NAVBAR_TOGGLER: '.yourex-navbar-toggler'
      /**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
  ...
  var Tooltip = function ($$$1) {
    ...
    var Selector = {
      TOOLTIP: '.yourex-tooltip',
      TOOLTIP_INNER: '.yourex-tooltip-inner',
      ARROW: '.yourex-arrow'
    };
    var Trigger = {
      HOVER: 'hover',
  ...
  var Popover = function ($$$1) {
    ...
    var Selector = {
      TITLE: '.yourex-popover-header',
      CONTENT: '.yourex-popover-body'
    };
    var Event = {
      HIDE: "hide" + EVENT_KEY,
      HIDDEN: "hidden" + EVENT_KEY,
  ...
  var ScrollSpy = function ($$$1) {
    ...
    var ClassName = {
      DROPDOWN_ITEM: 'yourex-dropdown-item',
      DROPDOWN_MENU: 'yourex-dropdown-menu',
      ACTIVE: 'yourex-active'
    };
    var Selector = {
      DATA_SPY: '[data-spy="scroll"]',
      ACTIVE: '.yourex-active',
      NAV_LIST_GROUP: '.yourex-nav, .yourex-list-group',
      NAV_LINKS: '.yourex-nav-link',
      NAV_ITEMS: '.yourex-nav-item',
      LIST_ITEMS: '.yourex-list-group-item',
      DROPDOWN: '.yourex-dropdown',
      DROPDOWN_ITEMS: '.yourex-dropdown-item',
      DROPDOWN_TOGGLE: '.yourex-dropdown-toggle'
    };
    var OffsetMethod = {
      OFFSET: 'offset',
      POSITION: 'position'
  ...
  var Tab = function ($$$1) {
    ...
    var Selector = {
      ...
      NAV_LIST_GROUP: '.yourex-nav, .yourex-list-group',
      ACTIVE: '.yourex-active',
      ACTIVE_UL: '> li > .yourex-active',
      DATA_TOGGLE: '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
      DROPDOWN_TOGGLE: '.yourex-dropdown-toggle',
      DROPDOWN_ACTIVE_CHILD: '> .yourex-dropdown-menu .yourex-active'
      /**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
...
$(function () {
  ...
  $("#side-bar-coin").niceScroll({
    cursorcolor: "#999",
    cursorborder: "5px solid #999"
  });
});

$(document).ready(function () {

  $(document).on('click', '#yourex-nav-toggle', function () {

    var expandState = $("#yourex-nav-toggle").attr('aria-expanded');

    if (expandState == "false") {
      $("#yourex-nav-toggle").attr("aria-expanded", "true");
      $("#yourex-navbarSupportedContent").fadeIn(1000).css("display", "").removeClass("yourex-collapse");
    } else {
      $("#yourex-nav-toggle").attr("aria-expanded", "false");
      $("#yourex-navbarSupportedContent").fadeOut(1000).css("display", "none").addClass("yourex-collapse");
    }
  });

  $(document).on('click', '#side-bar .yourex-side-bar-container a', function () {
    if ($(window).width() <= 991) {
      $("#side-bar").fadeToggle(1000, 'swing');
    }
  });

  $(document).on('click', '#showCoinBaseButton', function () {
    $("#showCoinBase").fadeToggle(1000, 'swing');
  });

  // THIS PART MANAGES THE SIDE NAV TOGGLING FOR SMALL SCREENS
  $(document).on('click', "#yourex-nav-toggler", function () {

    $("#side-bar").toggle("slow", function () {
      // $("#side-bar").fadeIn(1000);
    });
  });

  $(document).on('click', "#spentAddr", function () {
    var openState = $("#spentAddr").attr("data-tg-check");

    if (openState == 0) {
      $("#spentAddr").attr("data-tg-check", '1');
      $("#keylist").fadeIn(1000);
    } else {
      $("#spentAddr").attr("data-tg-check", '0');
      $("#keylist").fadeOut(500);
    }
  });
});
...
$(window).scroll(function () {
  ...
  if (height > 16) {
    $('#navAddStyle').addClass('yourex-nav-pop');
  } else if (height < 16) {
    $('#navAddStyle').removeClass('yourex-nav-pop');
  }
});

// THIS PART HANDLES THE DROPDOWN FOR THE PAGE

$(document).click(function () {
  var dropId = $("#yourex-drop-down").attr("data-specific-drop");
  $("#yourex-drop-down-show" + dropId).fadeOut(500);
});

$(document).on('click', '#yourex-drop-down', function (event) {
  /*
  	COLLECT THE ID FROM THE SPECIFIC DROPDOWN
  	'data-specific-drop'
  	THIS VALUE WILL BE ADDED TO THE PARTICULAR DROPDOWN TO BE SHOWN
  */
  var dropId = $("#yourex-drop-down").attr("data-specific-drop");
  $("#yourex-drop-down-show" + dropId).toggle();
  event.stopPropagation();
});

// THIS IS THE AREA THAT HANDLES ACCORDION ON THE HISTORY PAGES


$(document).on('click', "#accordionHeader", function () {

  var accordionId = $(this).attr("data-history-holder");
  $(".yourex-accordion-hide").addClass('yourex-display-none');
  // $(this).removeClass('yourex-accordion-notactive');
  $("#accordionHeader").addClass('yourex-accordion-notactive');

  $(this).removeClass('yourex-accordion-notactive');

  $("#historyCon" + accordionId).toggle();
});
/*
 * Toastr
 * Copyright 2012-2014 
