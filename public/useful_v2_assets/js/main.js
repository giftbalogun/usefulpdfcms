!(function (t) {
    ...
    p.length > 0 &&
        p.each(function () {
            ...
            e.countdown(a).on("update.countdown", function (e) {
                t(this).html(e.strftime(""));
            });
        });
    var v = t(".select");
    v.length > 0 &&
        v.each(function () {
            t(this).select2({ theme: "flat" });
        });
    var u = t(".select-bordered");
    u.length > 0 &&
        u.each(function () {
            t(this).select2({ theme: "flat bordered" });
        });
    // var m = ".toggle-tigger_OLD";
    // t(m).length > 0 &&
    ...
    // k.length > 0 &&
    //     k.each(function () {
    //         t(this).datepicker({ format: "mm/dd/yyyy", maxViewMode: 2, clearBtn: !0, autoclose: !0, todayHighlight: !0 });
    //     }),
    //     x.length > 0 &&
    //         x.each(function () {
    //             t(this).datepicker({ format: "mm/dd/yyyy", startView: 2, maxViewMode: 2, clearBtn: !0, autoclose: !0 });
    //         }),
    //     S.length > 0 &&
    //         S.each(function () {
    //             t(this).parent().addClass("has-timepicker"), t(this).timepicker({ timeFormat: "HH:mm", interval: 15 });
    //         }),
        ...
        new ClipboardJS(".copy-clipboard-modal", { container: document.querySelector(".modal") })
            .on("success", function (t) {
                T(t.trigger, "success"), t.clearSelection();
            })
            .on("error", function (t) {
    ...
    L.length > 0 &&
        L.each(function () {
            t(this).knob({ readOnly: !0, displayInput: !1 });
        });
    ...
    O.length > 0 &&
        ...
        O.each(function () {
            t(this).addClass("dropzone").dropzone({ url: "/images" });
        }));
    var A = t(".image-popup");
    A.length > 0 && A.magnificPopup({ type: "image", preloader: !0, removalDelay: 400, mainClass: "mfp-fade" });
    var B = t(".dt-init");
    B.length > 0 &&
        B.each(function () {
            var e = t(this),
    ...
    if (t("#tknSale").length > 0) {
        ...
        new Chart(H, {
            ...
            options: {
                ...
                scales: {
                    yAxes: [{ ticks: { beginAtZero: !0, fontSize: 12, fontColor: "#9eaecf" }, gridLines: { color: "#e5ecf8", tickMarkLength: 0, zeroLineColor: "#e5ecf8" } }],
                    xAxes: [{ ticks: { fontSize: 12, fontColor: "#9eaecf", source: "auto" }, gridLines: { color: "transparent", tickMarkLength: 20, zeroLineColor: "#e5ecf8" } }],
                },
            },
        });
    }
    ...
    if (t("#phaseStatus").length > 0) {
        ...
        new Chart(E, {
            ...
            data: {
                ...
                datasets: [{ label: "7960000", lineTension: 0, backgroundColor: [window.pieColors.pieColor1, window.pieColors.pieColor2], borderColor: "#fff", borderWidth: 2, hoverBorderColor: "#fff", data: [15.74, 84.26] }],
            },
            options: {
    ...
    if (t("#regStatistics").length > 0) {
        ...
        new Chart(N, {
            ...
            data: {
                ...
                datasets: [{ label: "", lineTension: 0, backgroundColor: "#2b56f5", borderColor: "#2b56f5", barThickness: 0.4, data: [3, 9, 5, 7, 10, 6, 2, 3, 9, 5, 7, 10, 6, 2, 3] }],
            },
            options: {
                legend: { display: !1 },
                maintainAspectRatio: !1,
                tooltips: { enabled: !1 },
                scales: {
                    yAxes: [{ ticks: { beginAtZero: !0, fontSize: 10, fontColor: "#9eaecf" }, gridLines: { color: "transparent", tickMarkLength: 0, zeroLineColor: "transparent" } }],
                    xAxes: [{ ticks: { fontSize: 9, fontColor: "#9eaecf", source: "auto" }, gridLines: { color: "transparent", tickMarkLength: 7, zeroLineColor: "transparent" } }],
                },
            },
        });
    }
    ...
    R.length > 0 &&
        R.on("click", function (a) {
            e.width() < 991 &&
                (t(this).parent().children(".navbar-dropdown").slideToggle(400),
    ...
    //     }),
    //     o.on("click", "body", function (t) {
    //         J.is(t.target) || 0 !== J.has(t.target).length || X.is(t.target) || 0 !== X.has(t.target).length || (X.removeClass("active"), j.removeClass("contact-active")),
    //             !q.is(t.target) &&
    //                 0 === q.has(t.target).length &&
    //                 !U.is(t.target) &&
    //                 0 === U.has(t.target).length &&
    //                 e.width() < 992 &&
    //                 (q.removeClass("active"), U.removeClass("active"), X.removeClass("short"), j.removeClass("information-active")),
    //             Q.is(t.target) || 0 !== Q.has(t.target).length || Z.is(t.target) || 0 !== Z.has(t.target).length || (Q.removeClass("active"), Z.removeClass("active"));
    //     });
    ...
    //         return $.removeClass("active"), Y.addClass("active"), null == t && Cookies.set("twz-offer", "true", { expires: 1, path: "" }), !1;
    //     }),
    //     e.on("load", function () {
